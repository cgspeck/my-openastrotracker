...
module BoardHolder6Pt(
    ...
    position_types=[
        ...
        [mount_3_type, hole_pts[2]],
        [mount_4_type, hole_pts[3]],
        [mount_5_type, hole_pts[4]],
        [mount_6_type, hole_pts[5]]
    ];
    ...
    fixing_pts = [ for(i=[0:fixing_holes]) [
        fixing_hole_origin.x + (fixing_hole_distance.x * (i)),
        fixing_hole_origin.y + (fixing_hole_distance.y * (i))
    ] ];
    ...
    module hole_4() {
        translate(hole_pts[4]) cylinder_outer(frame_height, frame_width / 2);
    }

    module hole_5() {
        translate(hole_pts[5]) cylinder_outer(frame_height, frame_width / 2);
    }
